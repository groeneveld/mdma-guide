...
\newglossaryentry{spiritual-bypass}{
  ...
  description={The use of spiritual attainments, practices, or beliefs as, perhaps unconscious reasons to not notice, investigate, or address one's maladaptive schemas \cite{cashwell2007Bypass}. This causes a variety of problems.}
...
\newglossaryentry{integration}{
  name={Integration},
  description={.}
  %defined_in={Reconsolidation Tools},
  %stem={integration}
}